...
(function ($) {
    ...
    var DEFAULT_SETTINGS = {
        ...
        hintSpanText: "use comma(,) to seperate tags",
    ...
    $.TokenList = function (input, url_or_data, settings) {
        ...
        var span_tag = $("<p class='hint font-10'>"+settings.hintSpanText+"</p>")
        .insertAfter(input_box).show();
        ...
        //input_box.width(input_resizer.width() + 250);
        }
        ...
        function insert_token(object) {
            ...
            if( settings.razaHack == null){
                var this_token = $("<li><p>"+ token_name +"</p></li>")
                .addClass(settings.classes.token)
                .insertAfter(input_token) //Hack:Raza change it from before to after
        ...
        function delete_token (token) {
            ...
            // Show the input box and give it focus again
            //  input_box.focus().css('color', '');  Hack:Raza
            if( settings.razaHack != null ){
            ...
            $.each(saved_tokens, function (index, value) {
                if(value.id) {
                    if(settings.extraParam == null){
                        ...
                        token_ids[token_ids.length] = value.name;
                    }
                } else {
        ...
        function show_dropdown() {
            if( settings.razaHack == null ){
                ...
                .css({
                    position: "absolute",
                    top: $(input_box).offset().top + $(input_box).outerHeight(), //Hack:Raza change token_list to input_box
                    left: $(input_box).offset().left, //Hack:Raza change token_list to input_box
                    zindex: 999
                })
                .show();
            }else{
        ...
        function run_search(query) {
            ...
            if(cached_results) {
                ...
                if(settings.url) {
                    ...
                    if(settings.extraParam != null){
                        ajax_params.data[settings.extraParam]= settings.extraValue
                    }
